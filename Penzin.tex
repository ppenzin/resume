...
\cventry{July~2014--Current}{Compiler Engineer}{The Portland Group, Inc (NVIDIA)}{Beaverton, Oregon}{}{Developed software front-end for international money transfers and Net Worth Monitoring system.\newline{}Select higlights:
\begin{itemize}
  \item LLVM support in CORAL compilers
  \item OpenMP runtime mainenance
\end{itemize}}
