...
\cventry{Jul~2018--Current}{Web Runtime Compiler Engineer / Standards Lead}{Intel}{Hillsboro, OR}{}{
WebAssembly and JavaScript
\begin{itemize}
  \item WebAssembly standard contributor, mostly working on cross-platform SIMD definition
  \begin{itemize}
    \item Co-chairing SIMD subgroup of the WebAssembly Community Group
    \item Proposed and developing Flexible Vectors extension
    \item Contributed to now-standard WebAssmbly SIMD
  \end{itemize}
  \item Web runtime optimizations for Wasm SIMD in V8 and ChakraCore
\end{itemize}}
...
\cventry{}{Maintainer}{ChakraCore}{JavaScript engine with a C API, formerly part of Edge}{github.com/chakra-core/ChakraCore}{Maintenance and various improvements: WebAssembly SIMD, CMake build definition, assorted project upkeep.}
