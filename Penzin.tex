...
\cvitem{~}{Software engineer, where my knowledge of various programming languages, several Computer Architectures and platforms is valued.}

\section{Technical expertise}
\cvitem{Languages}{Java, C, R, Ruby, C++, Haskell, Pascal}
...
\cvitem{Debuggers}{JDB, WinDBG, GDB, PGDBG, Various IDE built-in debuggers}
\cvitem{Configuration}{Puppet, Vagrant}
\cvitem{Verification}{Jenkins, Valgrind}
\cvitem{Frameworks}{Hibernate, JMX, Apache Camel, TIBCO, DCOM, Delphi, MPI, OpenMP, Pthreads, .NET}
...
\cventry{Apr~2013--Current}{SW Engineer / Tech Lead}{UTi Worldwide}{Portland, OR}{}{Software developer in the Platform team. Worked on performance analysis and system tools, provided recommendations to other teams.\newline{}%
Detailed achievements:
\begin{itemize}
\item Deployment request tool (in progress)
  \begin{itemize}
...
\item Developed ARM Disassembler
  ...
  \end{itemize}
\end{itemize}}
\cventry{Oct~2008--Dec~2009}{Software Engineer}{Industrial Energy Bank}{Vologda, Russia}{}{Developed software front-end for international money transfers and Net Worth Monitoring system.\newline{}Some achievements:
\begin{itemize}
  \item Implemented support for fractional part conversion for foreign exchange transfers.
  \item Created a system to monitor interest rates of bank's incoming and outgoing liabilities.
\end{itemize}}
