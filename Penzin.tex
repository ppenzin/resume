...
Worked on perfomance analysis, backend and front-end development, optimizations. \newline{}Some projects:
\begin{itemize}
  ...
  \end{itemize}
  \item Participated in poriting PGI C, C++, and Fortran compilers to OpenPower\newline{}Select highlights:
  \begin{itemize}
    \item Analysed benchmark results, investigated and fixed correctness errors
