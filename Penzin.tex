...
\cvitem{~}{Utilize my experience with various kinds of low-level software development.}
...
\cventry{July~2014--Current}{System Software Engineer --- Compiler Developer}{NVIDIA}{Beaverton, OR}{}{
Compiler engineer working on Portland Group (PGI) product line. Worked on
backend and front-end development, optimizations, performance analysis.
\begin{itemize}
  \item Compiler maintenance
  \begin{itemize}
    \item Improved Fortran procedure pointer handling
    \item GNU register variable extension support in LLVM backend
    \item Improved OpenMP nesting support
  \end{itemize}
  \item Flang --- open source LLVM Fortran compiler (DOE contract), derived from Portland Group Fortran compiler
  \begin{itemize}
    \item Implemented a new path in Clang toolchain to compile Fortran sources files and handle Fortran-specific command line options
